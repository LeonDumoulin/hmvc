...
class Attachment
{
    ...
    public static function addAttachment($file, $model, $folder_name, array $options = []): void
    {
        ...
        if (!file_exists($destinationPath)) {
            ...
            mkdir(public_path() . "/uploads/thumbnails/$folder_name", 0755,true);
        }
     ...
     * @return bool
     */
    public static function deleteAttachment($model, $relation = 'attachmentRelation', $multiple = false, $type = 'photo')
    {
