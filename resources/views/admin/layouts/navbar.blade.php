                ...
                <div class="d-flex align-items-stretch">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/pattern-1.jpg')">
                            <h3 class="text-white fw-bold px-9 mt-10 mb-6">{{__('اﻹشعارات')}}
                                <span class="fs-8 opacity-75 ps-3">{{$notifications->count()}}&nbsp;{{__('إشعارات جديدة')}}</span></h3>
                        </div>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="../../demo13/dist/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">{{__('عرض الكل')}}
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{route('admin.profile')}}" class="menu-link px-5">
                                <span class="menu-icon"><i class="bi bi-person-circle fs-3"></i></span>{{__('إعدادات الحساب')}}
                            </a>
                        </div>
                        <div class="separator my-1"></div>
                        <div class="menu-item px-5">
                            <a href="{{route('admin.logout')}}" class="menu-link px-5">
                                <span class="menu-icon"><i class="bi bi-box-arrow-right fs-3"></i></span>{{__('تسجيل الخروج')}}
                            </a>
                        </div>
...
<script type="text/javascript">
    ...
    // const notificationQuery = {command: "notification", to: "{{request()->get('user_id')}}", from: "{{auth()->id()}}" }
