                        ...
                        <td class="text-muted">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                ...
                                <div class="menu-item px-3">
                                    <a href="../../demo13/dist/apps/user-management/users/view.html" class="menu-link px-3 text-primary">{{__('تعديل')}}&nbsp;&nbsp;<i class="fa fa-edit text-primary"></i></a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3 text-danger">
                                    <a href="#" class="menu-link px-3 text-danger" data-kt-users-table-filter="delete_row">{{__('حذف')}}&nbsp;&nbsp;<i class="fa fa-trash text-danger"></i></a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
