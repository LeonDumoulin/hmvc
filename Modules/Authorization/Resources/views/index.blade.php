                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{url('/admin/roles/${data.id}/edit')}}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        {{__('تعديل')}}
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form action="{{url('admin/roles/2')}}" method="POST">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
                                        <button class="btn btn-primary" type="submit">حذف</button>
                                    </form>
                                    <a href="{{url('admin/roles/2')}}" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        {{__('حذف')}}
                                    </a>
                                </div>
                                <!--end::Menu item-->
